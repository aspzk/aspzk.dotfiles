...
-- ============================================
-- | Aspzk's New Hyprland Configuration Files |
-- ============================================
...
-- DP-2 à direita, começando onde o HDMI-A-1 termina
hl.monitor({
    output   = "DP-2",
...
hl.on("hyprland.start", function ()
  hl.exec_cmd("bash -c '/home/aspzk/.config/hypr/xdg-portal-hyprland'")
end)
...
hl.on("config.reloaded", function()
    hl.exec_cmd("start-pulseaudio-x11")
end)
